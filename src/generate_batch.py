...
def updated_get_data(first_coeff_path, audio_path, device, ref_eyeblink_coeff_path, still=False, idlemode=False,
             length_of_audio=False, use_blink=True):
    syncnet_mel_step_size = 16
    fps = 25
    ...
    return indiv_mels, ref_coeff, num_frames, ratio, audio_name, pic_name