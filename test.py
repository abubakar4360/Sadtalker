...
def main(args):
    ...
    if args.rank == 0:
        ...
        data = {}
        for pt_path in ['workspace/source_image.pt', 'workspace/source_semantics.pt',
    ...
    result = animate_from_coeff.generate(data, save_dir, pic_path, crop_info, \
                                         ...
                                         preprocess=args.preprocess, img_size=args.size, rank=args.rank,
                                         p_num=args.p_num, bf16=args.bf16)
